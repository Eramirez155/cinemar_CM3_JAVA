...
public class App{
   public static void main(String[]args){
	   String log4jConfPath = "C:\\Users\\Edgardo Lamas\\Desktop\\cinemar_CM3_JAVA\\Cinemar\\to\\log4j.properties"; // cambien el path
	   PropertyConfigurator.configure(log4jConfPath);
       Gson mapper= new Gson();
       // port(8080);
       Clasificacion clasi = new Clasificacion(1, 14, "ESta pelicula es apta para mayores de +14 años");
       TipoPelicula tipo = new TipoPelicula(5, "Inglish", "4D", true);
